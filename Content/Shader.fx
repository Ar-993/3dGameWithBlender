...
// Массив матриц костей (до 72 костей)
#define MAX_BONES 72
...
VertexShaderOutput MainVS(in VertexShaderInput input)
{
    ...
    // Скининг: вычисляем итоговое трансформационное воздействие костей
    ...
    // Применяем скининг к позиции и нормали перед трансформацией World
